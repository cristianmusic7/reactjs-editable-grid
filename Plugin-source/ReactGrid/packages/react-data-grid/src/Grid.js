...
const Grid = React.createClass({
  ...
  render(): ?ReactElement {
    ...
    let fixGridHeight = this.props.rowHeight*(this.props.freezedRowsFromTopCount+1);
        ...
        <Header
          ...
          />
            ...
            {this.props.rowsCount >= 1 || (this.props.rowsCount === 0 && !this.props.emptyRowsView) ?
              (<div ref={(node) => { this.viewPortContainer = node; } } className="fixed-grid-rows" tabIndex="0" 
              ...
              >
                  <Viewport
                    ref={(node) => { this.viewportFixed = node; } }
          ...
          {this.props.rowsCount >= 1 || (this.props.rowsCount === 0 && !this.props.emptyRowsView) ?
            (<div ref={(node) => { this.viewPortContainer = node; } } tabIndex="0" className="grid-rows"
            onKeyDown={this.props.onViewportKeydown} onKeyUp={this.props.onViewportKeyup} 
            onDoubleClick={this.props.onViewportDoubleClick}   
            onDragStart={this.props.onViewportDragStart} 
            onDragEnd={this.props.onViewportDragEnd}>
